...
//  iOS-Calculator
//
//  Created by Camilo Gonzalez on 09-06-22.
//
...
final class HomeViewController: UIViewController {
    ...
    @IBOutlet weak var opertatorPlusMinus: UIButton!
    ...
    @IBAction func opertatorPlusMinusAction(_ sender: UIButton) {
        temp = temp * (-1)
